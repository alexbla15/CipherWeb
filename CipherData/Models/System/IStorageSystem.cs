...
namespace CipherData.Models
{
    public interface IStorageSystem : IResource
    {
        ...
        /// </summary>
        public static Tuple<List<IStorageSystem>, ErrorResponse> Containing(string SearchText)
        {
            var result = GetObjects<StorageSystem>(SearchText, searchText => new GroupedBooleanCondition()
            {
        ...
        public static Tuple<List<IEvent>, ErrorResponse> Events(string? SelectedSystem)
        {
            ...
            var result = GetObjects<RandomEvent>(SelectedSystem, SelectedSystem => new GroupedBooleanCondition()
            {
                Conditions = new List<BooleanCondition>()
            {
        ...
        public static Tuple<List<IProcess>, ErrorResponse> Processes(string? SelectedSystem)
        {
            ...
            var result = GetObjects<RandomProcess>(SelectedSystem, SelectedSystem => new GroupedBooleanCondition()
            {
                Conditions = new List<BooleanCondition>()
            {
        ...
        public static Tuple<List<IPackage>, ErrorResponse> Packages(string? SelectedSystem)
        {
            ...
            var result = GetObjects<RandomPackage>(SelectedSystem, SelectedSystem => new GroupedBooleanCondition()
            {
                Conditions = new List<BooleanCondition>()
            {
        ...
        public static Tuple<List<IVessel>, ErrorResponse> Vessels(string? SelectedSystem)
        {
            ...
            var result = GetObjects<RandomVessel>(SelectedSystem, SelectedSystem => new GroupedBooleanCondition()
            {
                Conditions = new List<BooleanCondition>()
            {
