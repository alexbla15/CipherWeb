...
namespace CipherData.Models
{
    public interface IVessel: IResource
    {
        ...
        /// </summary>
        public static Tuple<List<IVessel>, ErrorResponse> Containing(string SearchText)
        {
            var result = GetObjects<Vessel>(SearchText, searchText => new GroupedBooleanCondition()
            {
