namespace CipherData.Models
{
    public interface IProcessDefinition : IResource
    {
        ...
        /// </summary>
        public static Tuple<List<IProcessDefinition>, ErrorResponse> Containing(string SearchText)
        {
            var result = GetObjects<ProcessDefinition>(SearchText, searchText => new GroupedBooleanCondition()
            {
