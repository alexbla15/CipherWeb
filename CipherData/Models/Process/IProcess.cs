namespace CipherData.Models
{
    public interface IProcess : IResource
    {
        ...
        /// </summary>
        public static Tuple<List<IProcess>, ErrorResponse> Containing(string SearchText)
        {
            var result = GetObjects<Process>(SearchText, searchText => new GroupedBooleanCondition()
            {
